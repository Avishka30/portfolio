    ...
    <section className="min-h-[90vh] flex flex-col md:flex-row items-center justify-between px-6 max-w-6xl mx-auto gap-12 pt-20">
      ...
      <div className="flex-1 space-y-6 order-2 md:order-1">
        ...
        <div className="flex flex-wrap gap-3 text-xs font-mono">
          <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full">FULL STACK DEVELOPER</span>
          <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full">MERN STACK DEVELOPER</span>
          <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full">MOBILE DEVELOPER</span>
        </div>
        ...
        <p className="max-w-xl text-lg text-gray-400 leading-relaxed">
          ...
          Currently specializing in <span className="text-white">Spring Boot</span>, the MERN stack, and React Native to turn 
